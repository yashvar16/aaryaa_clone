...
import 'package:arya_digital/navigation_pages/bottom_bar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GNav(
        ...
        hoverColor:
            const Color.fromARGB(15, 17, 3, 49), // tab button hover color
        ...
        tabBackgroundColor: const Color.fromARGB(
            15, 17, 3, 49), // selected tab background color
      ...
      body: Obx(() => navController.pages[navController.index.value]),
    );
  }
}
